  ...
  return (
    <div className="app">
      <div id="main" className="main-container" style={width <= 1024 ? {height: 'auto', width: '100%', paddingBottom: 150} : { paddingBottom: 200}}>
        ...
        {width > 1024 ?
          <React.Fragment>
            ...
            <div className="main-description" style={{fontSize: '19px'}}>
          ...
          <React.Fragment>
            ...
            <div className="main-description" style={{fontWeight: 'bold', fontSize: '12px', width: 250, marginTop: 20, marginBottom: 20}}>
              Shiba Run is a P2E Digital Dog Racing Game Where Players Own, Race, and Breed NFT Shibas!
            </div>
            <div>
      ...
      {width > 1024 ?
        ...
        <div id="shibas" className="shibas-container" style={{width: '100%', backgroundColor: '#E2FAFF'}}>
          <div style={{width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center'}}>
            <div style={{color: '#3C2507', fontSize: 50, marginTop: 80, marginBottom: 26, fontWeight: 'bold'}}>NFT SHIBA</div>
            <div style={{width: '70%', color: '#8B7561'}}>Shiba Run is a play-to-earn (P2E) dog racing game where players earn $Bark tokens based on their game play.</div>
          </div>
      ...
      {width > 1024 ?
        ...
        <div id="stadiums" className="stadiums-container">
          <div style={{width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center'}}>
            <div style={{color: '#2C7751', fontSize: 50, marginTop: 80, marginBottom: 80, fontWeight: 'bold'}}>NFT STADIUMS</div>
          ...
          <div style={{width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column'}}>
              <FeatureCard 
                ...
                textStyle={{color: '#26E39B', fontSize: 24, fontWeight: 'bold'}} 
              ...
              <FeatureCard 
                ...
                textStyle={{color: '#FB9534', fontSize: 24, fontWeight: 'bold'}}
              ...
              <FeatureCard 
                ...
                textStyle={{color: '#197BF2', fontSize: 24, fontWeight: 'bold'}}
      ...
      <div id="ecosystem" className="ecosystem-container" style={{width: '100%', backgroundColor: '#F6FFEF'}}>
        <div style={{width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center'}}>
          <div style={{color: '#155A0A', fontSize: 50, marginTop: 80, marginBottom: 80, fontWeight: 'bold'}}>Ecosystem</div>
      ...
      <div id="roadmap" className="roadmap-container" style={{width: '100%'}}>
        <div style={{ paddingTop: 150, paddingBottom: 150, marginLeft: 100, marginRight: 100}}>
          <div style={{color: '#997343', fontSize: 50, alignSelf: 'flex-start', marginBottom: 80, fontWeight: 'bold'}}>ROADMAP</div>
      ...
      <div id="roadmap" className="roadmap-container" >
        <div style={{paddingLeft: 20, paddingRight: 20, paddingTop: 120, display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
          <div style={{color: '#997343', fontSize: 50, marginBottom: 80, fontWeight: 'bold'}}>ROADMAP</div>
          <div>
            <RoadmapCard
      ...
      <div id="team" className="team-container">
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingTop:150, marginLeft: 100, marginRight: 100 }}>
          <div style={{color: '#236363', fontSize: 50, alignSelf: 'flex-start', marginBottom: 80, fontWeight: 'bold'}}>CORE TEAM</div>
          <div style={{}}>
            ...
            <div style={{display:'flex', flexDirection: 'row', marginBottom: 700}}>
              <TeamCard 
                ...
                name={'DAIZY'} 
                title={'SC Developer'} 
                description={'Daizy is a tech-nerd who graduated from PrincetonUniversity and had worked at Facebookas a full-stack dev. Daizy is the lead web & smartcontract developer for Shiba Run.'} 
              />
              <TeamCard 
                image={shiba01} 
                name={'KIMCH ARTIST'} 
      ...
      <div id="team" className="team-container" >
        <div style={{width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
          <div style={{color: '#236363', fontSize: 50, marginTop: 80, fontWeight: 'bold'}}>CORE TEAM</div>
      ...
      <div className='community-container' style={{backgroundColor: '#4B3119', height: 250, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        <div style={{width: '80%', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50}}>
            <img src={SecondaryLogo} alt="Shiba Run Logo" style={{width: 350, marginRight: 100}}/>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
              <div style={{fontSize: 20, color: 'white', marginBottom: 20, fontWeight: 'bold'}}>JOIN OUR COMMUNITY</div>
              <div style={{flexDirection: 'row', display: 'flex'}}>
                <img style={{marginRight: 30, width: 50}} className="header-social-btn" src={DiscordLogo} alt="Discord Btn" />
                <img style={{width: 50}} className="header-social-btn" src={TwitterLogo} alt="Discord Btn" />
              </div>
            </div>
        </div>
      </div>
